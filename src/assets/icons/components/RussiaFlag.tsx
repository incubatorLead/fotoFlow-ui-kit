...
const SvgRussiaFlag = (props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => (
  <svg xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 24 24" ref={ref} {...props}>
    <path fill="url(#RussiaFlag_svg__a)" d="M0 0h24v24H0z" />
    <defs>
      <pattern id="RussiaFlag_svg__a" width={1} height={1} patternContentUnits="objectBoundingBox">
        <use xlinkHref="#RussiaFlag_svg__b" transform="scale(.01389)" />
      </pattern>
      <image
