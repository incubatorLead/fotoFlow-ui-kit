...
const SvgColorPaletteOutline = (props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" ref={ref} {...props}>
    ...
    <path
      fill="currentColor"
      d="M12 8a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3M15.25 7.2a1.5 1.5 0 1 0 1.501 2.598A1.5 1.5 0 0 0 15.25 7.2M8.75 7.2a1.5 1.5 0 1 0-1.498 2.6A1.5 1.5 0 0 0 8.75 7.2M6.16 11.26a1.5 1.5 0 1 0 2.08.4 1.49 1.49 0 0 0-2.08-.4"
    />
  </svg>
)
