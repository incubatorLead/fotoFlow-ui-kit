...
const SvgPaid = (props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" ref={ref} {...props}>
    ...
    <path
      fill="currentColor"
      d="M15.08 8.14a.667.667 0 0 0-.94.113l-4.667 6-2.286-2.786a.666.666 0 1 0-1.04.833l2.78 3.453a.67.67 0 0 0 .52.247.67.67 0 0 0 .553-.253l5.22-6.667a.667.667 0 0 0-.14-.94M18.413 8.14a.666.666 0 0 0-.94.113l-4.666 6-.407-.5-.84 1.08.733.914a.67.67 0 0 0 1.04-.007l5.22-6.667a.666.666 0 0 0-.14-.933"
    />
    <path
      fill="currentColor"
